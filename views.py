...
def Home(request):
   ...
   context={'total_customer':total_customer,'total_ordering':total_ordering,'delivered':delivered,'pending':pending,'out_for_delivery':out_for_delivery,
...
def update_order(request,pk):
        ...
        if request.method=='POST':
            form=UpdateOrder(request.POST,instance=orders)
            if form.is_valid():
               instance =form.save(commit=False)
            ...
            form=UpdateOrder(instance=orders)
        context={'form':form,
                 'orders':orders,
